...
// Input
var input = (0, _jquery.default)('#copytext');
var copyHTML = (0, _jquery.default)('#copy-html');
var copyCSS = (0, _jquery.default)('#copy-css');
var copySASS = (0, _jquery.default)('#copy-sass'); // Values

var toggleWidth = (0, _jquery.default)('#toggle-width__value').val() + 'px';
var toggleHeight = (0, _jquery.default)('#toggle-height__value').val() + 'px';
var togglePadding = (0, _jquery.default)('#toggle-padding__value').val() + 'px';
var toggleInactiveColor = (0, _jquery.default)('#toggle-inactive-color__value').val();
var toggleActiveColor = (0, _jquery.default)('#toggle-active-color__value').val();
var toggleInactiveHoverColor = (0, _jquery.default)('#toggle-inactive-hover-color__value').val();
var toggleActiveHoverColor = (0, _jquery.default)('#toggle-active-hover-color__value').val();
/* prettier-ignore */

(0, _jquery.default)('#controls').on('change', function () {
  toggleWidth = (0, _jquery.default)("#toggle-width__value").val() + "px";
  toggleHeight = (0, _jquery.default)("#toggle-height__value").val() + "px";
  togglePadding = (0, _jquery.default)("#toggle-padding__value").val() + "px";
  toggleInactiveColor = (0, _jquery.default)("#toggle-inactive-color__value").val();
  toggleActiveColor = (0, _jquery.default)("#toggle-active-color__value").val();
  toggleInactiveHoverColor = (0, _jquery.default)("#toggle-inactive-hover-color__value").val();
  toggleActiveHoverColor = (0, _jquery.default)("#toggle-active-hover-color__value").val();
  (0, _jquery.default)(document.documentElement).css('--toggle-width', toggleWidth);
  (0, _jquery.default)(document.documentElement).css('--toggle-height', toggleHeight);
  (0, _jquery.default)(document.documentElement).css('--toggle-padding', togglePadding);
  (0, _jquery.default)(document.documentElement).css('--inactive-color', toggleInactiveColor);
  (0, _jquery.default)(document.documentElement).css('--active-color', toggleActiveColor);
  (0, _jquery.default)(document.documentElement).css('--inactive-hover-color', toggleInactiveHoverColor);
  (0, _jquery.default)(document.documentElement).css('--active-hover-color', toggleActiveHoverColor);
});

var toggleHTML = function toggleHTML() {
...
var toggleCSS = function toggleCSS() {
  return "\n.checkbox-container {\n  display: flex;\n  align-items: center;\n  cursor: pointer;\n  padding-bottom: 10px;\n  box-sizing: border-box;\n  /* The order of these two is important */ }\n  .checkbox-container:nth-last-child(1) {\n    padding-bottom: 0; }\n  .checkbox-container:hover input ~ .checkmark {\n    background: ".concat(toggleInactiveHoverColor, "; }\n  .checkbox-container input ~ .label-text {\n    color: ").concat(toggleInactiveColor, ";\n    transition: 0.3s; }\n  .checkbox-container input:hover ~ .label-text {\n    color: ").concat(toggleInactiveHoverColor, "; }\n  .checkbox-container input:checked ~ .checkmark {\n    background-color: ").concat(toggleActiveColor, "; }\n  .checkbox-container input:checked:hover ~ .checkmark {\n    background: ").concat(toggleActiveHoverColor, "; }\n  .checkbox-container input:checked ~ .checkmark:after {\n    margin-left: calc(").concat(toggleWidth, " - ").concat(toggleHeight, "); }\n  .checkbox-container input:checked ~ .label-text {\n    color: ").concat(toggleActiveColor, "; }\n  .checkbox-container input:checked:hover ~ .label-text {\n    color: ").concat(toggleActiveHoverColor, "; }\n  .checkbox-container .checkmark {\n    display: flex;\n    justify-content: flex-start;\n    position: relative;\n    width: ").concat(toggleWidth, ";\n    height: ").concat(toggleHeight, ";\n    margin-right: 10px;\n    background: ").concat(toggleInactiveColor, ";\n    border-radius: 10000px;\n    padding: ").concat(togglePadding, ";\n    transition: 0.3s; \n    box-sizing: border-box }\n    .checkbox-container .checkmark:after {\n      content: \"\";\n      background: white;\n      display: block;\n      position: absolute;\n      height: calc(").concat(toggleHeight, " - (").concat(togglePadding, " * 2));\n      width: calc(").concat(toggleHeight, " - (").concat(togglePadding, " * 2));\n      border-radius: 100%;\n      transition: 0.3s; }\n  .checkbox-container .toggle {\n    position: absolute;\n    opacity: 0;\n    cursor: pointer;\n    height: 0;\n    width: 0; }");
};

var toggleSASS = function toggleSASS() {
